...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    //static void addActionListener(Project aThis) {
...
//    Random ran = new Random();
  //   long first6 = Math.abs((ran.nextInt()%900000L)+100000L);
   ...
   /*=============================================================================================*/
   /*================================================================================================*/   
       JLabel lblname = new JLabel("1) Teacher_Name:-"); 
       ...
       JLabel lTeachlist = new JLabel("3)project_Incharge_name:-");
        lTeachlist.setBounds(898,150,1000,30);
         lTeachlist.setFont(new Font("serif",Font.ITALIC,20));
        add(lTeachlist);
 ...
 /*================================================================================================*/   
        ...
        @SuppressWarnings("LocalVariableHidesMemberVariable")
         JLabel lblrollno = new JLabel("4)Teacher_id_number:");
      ...
      /*================================================================================================*/   
         //(left,top,length,width)
        JLabel lblemail = new JLabel("5) Teacher_Email Id:-");
       ...
       /*================================================================================================*/   
       //(left,top,length,width)  
       JLabel lbladdress = new JLabel("6) Teacher_Address:-");
 ...
 /*================================================================================================*/    
 /*================================================================================================*/   
        lStat = new JLabel("9) Teacher_State:-");
 ...
 /*================================================================================================*/          
     // tfproject = new JTextField();
       //   tfproject.setBounds(630,350,150,30);
         ...
         JLabel lage = new JLabel("11) Teacher_Age:-");
...
/*================================================================================================*/   
/*================================================================================================*/         
         lCoun = new JLabel("12) Teacher_Country:-");
...
/*================================================================================================*/           
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            tfphone.grabFocus();
                  ...
                  if(tfproject.getText().trim().length()==0){
            JOptionPane.showMessageDialog(this,"Please Enter your project Name");
            tfproject.setText("");
           tfproject.grabFocus();
        }
 ...
 String query="insert into student3 values('"+studentName+"'+'"+phone+"'+'"+studentproject+"''"+studentrollno+"'+'"+email+"'+'"+address+"'+'"+collegename+"'+'"+studentdob+"'+'"+studentstate+"'+'"+studentage+"'+'"+studentsemester+"'+'"+studentcoun+"')";
   ...
   // private void add(JLable lTeachlist){
    //}
